...
for take=1:5
    ...
    cancel1{3} = [0,0,0.52;]; % Cartesian
    max_vol1{3} = 0.6;

    focus1{4} = [0,0,0.4]; % Cartesian
    cancel1{4} = [0,0,0.52;]; % Cartesian
    max_vol1{4} = 0.6;

    focus1{5} = [0,0,0.4]; % Cartesian
    cancel1{5} = [0,0,0.52;]; % Cartesian
    max_vol1{5} = 0.6;

    focus1{6} = [0,0,0.4]; % Cartesian
    cancel1{6} = [0,0,0.52;]; % Cartesian
    max_vol1{6} = 0.6;

    focus1{7} = [0,0,0.4]; % Cartesian
    cancel1{7} = [0,0,0.52;]; % Cartesian
    max_vol1{7} = 0.6;

    focus1{8} = [0,0,0.4]; % Cartesian
    cancel1{8} = [0,0,0.52;]; % Cartesian
    max_vol1{8} = 0.6;

    focus2{1} = [0,0,0.6]; % Cartesian
    cancel2{1} = [0,0,0.48;0,0,0.72]; % Cartesian
    max_vol2{1} = 0.6;

    focus2{2} = [0,0,0.6]; % Cartesian
    cancel2{2} = [0,0,0.48;0,0,0.72]; % Cartesian
    max_vol2{2} = 0.6;

    focus2{3} = [0,0,0.6]; % Cartesian
    cancel2{3} = [0,0,0.48;0,0,0.72]; % Cartesian
    max_vol2{3} = 0.6;

    focus2{4} = [0,0,0.6]; % Cartesian
    cancel2{4} = [0,0,0.48;0,0,0.72]; % Cartesian
    max_vol2{4} = 0.6;

    focus2{5} = [0,0,0.6]; % Cartesian
    cancel2{5} = [0,0,0.48;0,0,0.72]; % Cartesian
    max_vol2{5} = 0.6;

    focus2{6} = [0,0,0.6]; % Cartesian
    cancel2{6} = [0,0,0.48;0,0,0.72]; % Cartesian
    max_vol2{6} = 0.6;

    focus2{7} = [0,0,0.6]; % Cartesian
    cancel2{7} = [0,0,0.48;0,0,0.72]; % Cartesian
    max_vol2{7} = 0.6;

    focus2{8} = [0,0,0.6]; % Cartesian
    cancel2{8} = [0,0,0.48;0,0,0.72]; % Cartesian
    max_vol2{8} = 0.6;
    
    focus3{1} = [0,0,0.48;0,0,0.76]; % Cartesian
    cancel3{1} = [0,0,0.64]; % Cartesian
    max_vol3{1} = 0.65;

    focus3{2} = [0,0,0.48;0,0,0.76]; % Cartesian
    cancel3{2} = [0,0,0.64;]; % Cartesian
    max_vol3{2} = 0.65;

    focus3{3} = [0,0,0.48;0,0,0.76]; % Cartesian
    cancel3{3} = [0,0,0.64]; % Cartesian
    max_vol3{3} = 0.65;

    focus3{4} = [0,0,0.48;0,0,0.76]; % Cartesian
    cancel3{4} = [0,0,0.64]; % Cartesian
    max_vol3{4} = 0.65;

    focus3{5} = [0,0,0.48;0,0,0.76]; % Cartesian
    cancel3{5} = [0,0,0.64]; % Cartesian
    max_vol3{5} = 0.65;

    focus3{6} = [0,0,0.48;0,0,0.76]; % Cartesian
    cancel3{6} = [0,0,0.64]; % Cartesian
    max_vol3{6} = 0.65;

    focus3{7} = [0,0,0.48;0,0,0.76]; % Cartesian
    cancel3{7} = [0,0,0.64]; % Cartesian
    max_vol3{7} = 0.65;

    focus3{8} = [0,0,0.48;0,0,0.76]; % Cartesian
    cancel3{8} = [0,0,0.64]; % Cartesian
    max_vol3{8} = 0.65;
	...
	fprintf('Patch no. %d of %d\n', j, n_patches)
        ...
        while max(cancel_mag1{j})>0.95 || max(cancel_mag2{j})>0.95 || max(cancel_mag3{j})>0.85    % If cancellation is bad, randomly choose electrode locations again
        cnt = cnt+1;
        if cnt>5000
...
%     figure,slice(xgrid,ygrid,zgrid,permute(fire_double, [2,1,3]),0,0,[0.32])  % Visualize, change the last three numbers to the plane of interest
    save(['Results_corrected/STIMULUS_all_',num2str(take)])
end
